...
import { teacherRegister } from "../../../services/auth";
            ...
            <form onSubmit={handleSignUp}>
                 ...
                 er-form-strokedark orm-input s:border-primary"
                  ...
                  <span className="absolute right-4 top-4">
                    ...
                    >
                      <g opacity="0.5">
                        <path
                          d="M16.5 2H15.5V0.5C15.5 0.22 15.28 0 15 0C14.72 0 14.5 0.22 14.5 0.5V2H7.5V0.5C7.5 0.22 7.28 0 7 0C6.72 0 6.5 0.22 6.5 0.5V2H5.5C4.12 2 3 3.12 3 4.5V18.5C3 19.88 4.12 21 5.5 21H16.5C17.88 21 19 19.88 19 18.5V4.5C19 3.12 17.88 2 16.5 2ZM17.5 18.5C17.5 19.05 17.05 19.5 16.5 19.5H5.5C4.95 19.5 4.5 19.05 4.5 18.5V8H17.5V18.5ZM17.5 6.5H4.5V4.5C4.5 3.95 4.95 3.5 5.5 3.5H6.5V4.5C6.5 4.78 6.72 5 7 5C7.28 5 7.5 4.78 7.5 4.5V3.5H14.5V4.5C14.5 4.78 14.72 5 15 5C15.28 5 15.5 4.78 15.5 4.5V3.5H16.5C17.05 3.5 17.5 3.95 17.5 4.5V6.5Z"
                          fill=""
                        />
                      </g>
                    </svg>
              ...
              <div className="mb-5">
                <input
                  ...
                  className="w-full cursor-pointer bg-blue-800 rounded-lg border border-primary bg-primary p-4 text-white transition hover:bg-opacity-90"
                />
              </div>
              ...
              <div className="mt-6 text-center">
                <p>
                  ...
                  <Link to="/auth/teacher/signin" className="text-primary">
                    Sign in
                  </Link>
                </p>
              </div>
