            ...
            <div className="flex flex-wrap items-center">
              <div className="hidden w-full xl:block xl:w-1/2">
                <div className="py-17.5 px-26 text-center">
                  ...
                  <p className="2xl:px-20 tracking-widest text-xl font-medium">
      ...
      <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
        <div className="w-full max-w-full bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="mb-8 text-center">
            ...
            <p className="text-gray-500 text-sm">Access your admin portal</p>
          </div>
          ...
          <form onSubmit={handleSignIn} className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full h-12 bg-blue-500 hover:bg-blue-600 text-white rounded-md font-medium transition"
            >
              Sign In
            </button>
          </form>
