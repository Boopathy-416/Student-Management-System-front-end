...
export default function TeacherSignIn() {
  ...
  const from = location.state?.from?.pathname || "/dashboard/teacher";
        ...
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-20 text-center">
              ...
              <p className="2xl:px-20 tracking-widest text-xl font-semibold">
              ...
              <form onSubmit={handleSignIn}>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/auth/teacher/signup" className="text-primary">
                     <mark>Sign Up</mark> 
                    </Link>
                  </p>
                </div>
